...
import testepacote.repository.AulaRepository;
...
public class AulaResourceIntTest {
    ...
    public void createAula() throws Exception {
        ...
        assertThat(testAula.getHorario()).isEqualTo(DEFAULT_HORARIO);
    }
    ...
    public void updateAula() throws Exception {
        ...
        assertThat(testAula.getHorario()).isEqualTo(UPDATED_HORARIO);
    }
