...
import testepacote.config.audit.AuditEventConverter;
import testepacote.domain.PersistentAuditEvent;
...
import static testepacote.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
